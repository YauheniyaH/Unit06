...
public class Book {
	...
	public Book(String title, String authors, int year, String publisher, int pagesNumber, double price, String bindingForm) {
	...
	public String toString() {
		return "Book [id=" + id + ", title=" + title + ", authors=" + authors + ", year=" + year + ", publisher="
